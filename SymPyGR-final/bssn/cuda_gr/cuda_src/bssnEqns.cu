...
__global__ void cuda_bssn_eqns_points_b_chi_rhss(double * dev_var_in, double * dev_var_out, 
...
__global__ void cuda_bssn_eqns_points_Gt_rhs_1_2_3(double * dev_var_in, double * dev_var_out, 
    const unsigned int host_sz_x, const unsigned int host_sz_y, const unsigned int host_sz_z,  
    double pmin_x, double pmin_y, double pmin_z, 
    double hz, double hy, double hx, 
    #include "para_derivs_offsets.h"
...
__global__ void cuda_bssn_eqns_points_Gt_rhs_5_7(double * dev_var_in, double * dev_var_out, 
    const unsigned int host_sz_x, const unsigned int host_sz_y, const unsigned int host_sz_z,  
    double pmin_x, double pmin_y, double pmin_z, 
    double hz, double hy, double hx, 
    #include "para_derivs_offsets.h"
...
__global__ void cuda_bssn_eqns_points_a_Gt_rhss(double * dev_var_in, double * dev_var_out, 
    const unsigned int host_sz_x, const unsigned int host_sz_y, const unsigned int host_sz_z,  
    double pmin_x, double pmin_y, double pmin_z, 
    double hz, double hy, double hx, 
    #include "para_derivs_offsets.h"
...
_global__ void cuda_bssn_eqns_points_B_rhs(double * dev_var_in, double * dev_var_out, 
    const unsigned int host_sz_x, const unsigned int host_sz_y, const unsigned int host_sz_z,  
    double pmin_x, double pmin_y, double pmin_z, 
    double hz, double hy, double hx, 
    #include "para_derivs_offsets.h"
...
)
{
    ...
    cuda_bssn_eqns_points_b_chi_rhss<<< number_of_blocks_128_threads, 128, 0, stream >>>(dev_var_in, dev_var_out, 
    ...
    cuda_bssn_eqns_points_Gt_rhs_1_2_3<<< number_of_blocks_128_threads, 128, 0, stream >>>(dev_var_in, dev_var_out, 
        host_sz_x, host_sz_y, host_sz_z, 
        pmin_x, pmin_y, pmin_z, 
        hz, hy, hx, 
        #include "args_derivs_offsets.h"
    ...
    cuda_bssn_eqns_points_Gt_rhs_5_7<<< number_of_blocks_128_threads, 128, 0, stream >>>(dev_var_in, dev_var_out, 
        host_sz_x, host_sz_y, host_sz_z, 
        pmin_x, pmin_y, pmin_z, 
        hz, hy, hx, 
        #include "args_derivs_offsets.h"
    ...
    cuda_bssn_eqns_points_a_Gt_rhss<<< number_of_blocks_256_threads, 256, 0, stream >>>(dev_var_in, dev_var_out, 
        host_sz_x, host_sz_y, host_sz_z, 
        pmin_x, pmin_y, pmin_z, 
        hz, hy, hx, 
        #include "args_derivs_offsets.h"
